...
/* SerializedTypeKeyed_subscriber.c
...
rtiddsgen -language C -example <arch> SerializedTypeKeyed.idl

Example subscription of type SerializedTypeKeyed automatically generated by 
...
objs/<arch>/SerializedTypeKeyed_subscriber <domain_id> <sample_count>

(3) Start the publication on the same domain used for RTI Data Distribution
Service with the command
objs/<arch>/SerializedTypeKeyed_publisher <domain_id> <sample_count>
...
objs/<arch>/SerializedTypeKeyed_publisher <domain_id> 
objs/<arch>/SerializedTypeKeyed_subscriber <domain_id> 
    ...
    DDS_DataReader* reader)
{
    ...
    for (i = 0; i < SerializedTypeKeyedSeq_get_length(&data_seq); ++i) {
        if (DDS_SampleInfoSeq_get_reference(&info_seq, i)->valid_data) {
            ...
            SerializedTypeKeyedTypeSupport_print_data(
                SerializedTypeKeyedSeq_get_reference(&data_seq, i));
        }
    }
...
static int subscriber_main(int domainId, int sample_count)
{
    ...
    retcode = SerializedTypeKeyedTypeSupport_register_type(participant, type_name);
    if (retcode != DDS_RETCODE_OK) {
