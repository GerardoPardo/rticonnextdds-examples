...
Example subscription of type SerializedType automatically generated by 
...
void SerializedTypeListener::on_data_available(DDSDataReader* reader)
{
    SerializedTypeDataReader *SerializedType_reader = NULL;
    SerializedTypeSeq data_seq;
    DDS_SampleInfoSeq info_seq;
    DDS_ReturnCode_t retcode;
    int i;

    SerializedType_reader = SerializedTypeDataReader::narrow(reader);
    if (SerializedType_reader == NULL) {
        fprintf(stderr, "DataReader narrow error\n");
        return;
    }

    retcode = SerializedType_reader->take(
    ...
    retcode = SerializedType_reader->return_loan(data_seq, info_seq);
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    DDSTopic *topic = NULL;
    SerializedTypeListener *reader_listener = NULL; 
    ...
    reader_listener = new SerializedTypeListener();
