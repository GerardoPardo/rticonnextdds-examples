    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_sample) {
        ...
        if (!RTICdrStream_serializeString(
            stream, sample->color, ((COLOR_LENGTH_MAX)) + 1)) {
            return RTI_FALSE;
        }
    ...
    try {
        ...
        if(deserialize_sample) {
            ...
            if (!RTICdrStream_deserializeStringEx(
                stream,&sample->color, ((COLOR_LENGTH_MAX)) + 1, RTI_FALSE)) {
                goto fin; 
            }
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (skip_sample) {
        ...
        if (!RTICdrStream_skipString (stream, ((COLOR_LENGTH_MAX))+1)) {
            goto fin; 
        }
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment +=RTICdrType_getStringMaxSizeSerialized(
        current_alignment, ((COLOR_LENGTH_MAX))+1);
